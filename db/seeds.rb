...
User.create(facebook: "https://www.facebook.com/profile.php?id=100005615115122", firstName: "Malte", lastName: "Evers", email: "a@fh-muenster.de", password: "12345678", team_id: "1", studiengang: "BA-Wirtschaftsinformatik", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/profile.php?id=100005615115122", firstName: "Matthias", lastName: "Heinen", email: "heinen.m@fh-muenster.de", password: "12345678", team_id: "2", studiengang: "BA-Wirtschaftsinformatik", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/malte.la.7?fref=ts", firstName: "Malte", lastName: "Lange", email: "malte@fh-muenster.de" ,password: "12345678", team_id: "3", studiengang: "BA-Wirtschaftsinformatik", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/myles.sutholt?fref=ts", firstName: "Myles", lastName: "Sutholt", email: "myles@fh-muenster.de" ,password: "12345678", team_id: "4", studiengang: "BA-Wirtschaftsinformatik", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/groups/649018005179998/?fref=ts", firstName: "Günther", lastName: "Netzer", email: "mh152235@fh-muenster.de" ,password: "12345678", team_id: "5", studiengang: "BWL", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/adventuretime/?fref=ts", firstName: "Fin", lastName: "the Human", email: "fin@fh-muenster.de" ,password: "12345678", team_id: "6", studiengang: "CALA", confirmed_at: DateTime.now)
User.create(facebook: "https://www.facebook.com/adventuretime/?fref=ts", firstName: "Jake", lastName: "the Dog", email: "jake@fh-muenster.de" ,password: "12345678", studiengang: "EBP", confirmed_at: DateTime.now)
